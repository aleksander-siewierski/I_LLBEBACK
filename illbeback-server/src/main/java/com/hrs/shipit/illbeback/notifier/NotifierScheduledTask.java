...
public class NotifierScheduledTask {
    ...
    private void initFakeData() {
        ...
        List<Job> jobListJobs = new ArrayList<>(2);
        Job job = new Job();
        ...
        ServerStatus server = new ServerStatus(detpuw1, jobListJobs);
        ...
        job.setColor("green");
        jobListJobs.add(job);
        server = new ServerStatus(detpuw2, jobListJobs);
